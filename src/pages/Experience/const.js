...
export const EXPERIENCE_CONFIGS = {
  works: [
    ...
    },
    {
      ...
      details: 'Develop website with automation testing and CI/CD using React, Docker, Jenkins',
    },
    {
  ...
  projects: [
    ...
    },
    {
      ...
      details: 'Full-stack development and design, web application for manage information in department using PHP.',
    },
  ],
  volunteers: [
    {
